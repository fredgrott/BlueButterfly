...
public class SVGParser extends DefaultHandler2
{
   ...
   protected SVG  parse(InputStream is) throws SVGParseException
   {
      ...
      finally
      {
         try {
            ...
            Timber.e(TAG, "Exception thrown closing input stream");
         }
      }
      return svgDocument;
   }
   ...
   {
      if (LibConfig.DEBUG)
         Timber.d(TAG, String.format(format, args));
   }
      ...
      while (true)
      {
         ...
         switch (pathCommand)
         {
            ...
            case 'm':
               ...
               if (Float.isNaN(y)) {
                  Timber.e(TAG, "Bad path coords for "+((char)pathCommand)+" path segment");
                  return path;
               }
