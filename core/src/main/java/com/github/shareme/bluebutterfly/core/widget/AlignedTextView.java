...
public class AlignedTextView extends com.github.shareme.bluebutterfly.core.widget.TextView {
  ...
  public AlignedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
