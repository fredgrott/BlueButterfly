...
import com.github.shareme.bluebutterfly.core.internal.SpinnerMenu;
...
public class Spinner extends EditText {
    ...
    protected boolean setFrame(int l, int t, int r, int b) {
        ...
        if (spinnerMenu != null) {
            com.github.shareme.bluebutterfly.core.widget.FrameLayout container = (FrameLayout) spinnerMenu.getContentView().findViewById(R.id.carbon_popupContainer);
