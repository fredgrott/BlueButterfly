...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        final ValueAnimator animator = ValueAnimator.ofFloat(view.getAlpha(), 0);
    ...
    private void animateAddImpl(final RecyclerView.ViewHolder holder) {
        final View view = holder.itemView;
        final ValueAnimator animator = ValueAnimator.ofFloat(view.getAlpha(), 1);
    ...
    private void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                view.setTranslationX(MathUtils.lerp(startX, 0, (Float) animation.getAnimatedValue()));
                view.setTranslationY(MathUtils.lerp(startY, 0, (Float) animation.getAnimatedValue()));
            }
        });
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    view.setAlpha(MathUtils.lerp(startAlpha, 0, (Float) animation.getAnimatedValue()));
                    view.setTranslationX(MathUtils.lerp(startX, changeInfo.toX - changeInfo.fromX, (Float) animation.getAnimatedValue()));
                    view.setTranslationY(MathUtils.lerp(startY, changeInfo.toY - changeInfo.fromY, (Float) animation.getAnimatedValue()));
                }
            });
        ...
        if (newView != null) {
            ...
            final float startAlpha = newView.getAlpha();
            final float startX = newView.getTranslationX();
            final float startY = newView.getTranslationY();
            newViewAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    newView.setAlpha(MathUtils.lerp(startAlpha, 1, (Float) animation.getAnimatedValue()));
                    newView.setTranslationX(MathUtils.lerp(startX, 0, (Float) animation.getAnimatedValue()));
                    newView.setTranslationY(MathUtils.lerp(startY, 0, (Float) animation.getAnimatedValue()));
                }
            });
