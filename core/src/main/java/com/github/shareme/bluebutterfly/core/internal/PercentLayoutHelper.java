...
public class PercentLayoutHelper {
    ...
    public void adjustChildren(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            Timber.d(TAG, "adjustChildren: " + mHost + " widthMeasureSpec: "
        ...
        for (int i = 0, N = mHost.getChildCount(); i < N; i++) {
            ...
            ViewGroup.LayoutParams params = view.getLayoutParams();
                ...
                Timber.d(TAG, "should adjust " + view + " " + params);

            if (params instanceof PercentLayoutParams) {
                PercentLayoutInfo info =
                        ((PercentLayoutParams) params).getPercentLayoutInfo();

                    Timber.d(TAG, "using " + info);
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context,
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent width: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent height: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent left margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent top margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent right margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent bottom margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent start margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "percent end margin: " + value);
        ...
        if (value != -1f) {
                ...
                Timber.v(TAG, "aspect ratio: " + value);
    ...
    public void restoreOriginalParams() {
        for (int i = 0, N = mHost.getChildCount(); i < N; i++) {
            ...
            ViewGroup.LayoutParams params = view.getLayoutParams();
                ...
                Timber.d(TAG, "should restore " + view + " " + params);
    ...
    public boolean handleMeasuredStateTooSmall() {
        ...
        for (int i = 0, N = mHost.getChildCount(); i < N; i++) {
            ...
            ViewGroup.LayoutParams params = view.getLayoutParams();
                ...
                Timber.d(TAG, "should handle measured state too small " + view + " " + params);
            ...
            Timber.d(TAG, "should trigger second measure pass: " + needsSecondMeasure);
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillLayoutParams(ViewGroup.LayoutParams params, int widthHint,
            ...
            if (aspectRatio >= 0) {
                ...
                Timber.d(TAG, "after fillLayoutParams: (" + params.width + ", " + params.height + ")");
        ...
        public void fillMarginLayoutParams(ViewGroup.MarginLayoutParams params, int widthHint,
            ...
            if (endMarginPercent >= 0) {
                ...
                Timber.d(TAG, "after fillMarginLayoutParams: (" + params.width + ", " + params.height
                        + ")");
