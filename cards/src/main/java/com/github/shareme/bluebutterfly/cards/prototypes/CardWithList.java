...
package com.github.shareme.bluebutterfly.cards.prototypes;
 ...
 */
@SuppressWarnings({"JavaDoc", "UnusedDeclaration", "unused"})
public abstract class CardWithList extends Card {
    ...
    /**
     * This method is called by the {@link CardWithList.LinearListAdapter} for each row.
     * You can provide your layout and setup your ui elements.
     *
     * @param childPosition position inside the list of objects
     * @param object        {@link CardWithList.ListObject}
     ...
     * It is used only if the {@see useEmptyView) is setted to true and the {@see mEmptyView} is a {@link ViewStub}.
     *
     * @return
     */
     ...
     * It is used only if the {@see useProgressBar) is setted to true and the {@see mProgressView} is a {@link ViewStub}.
     *
     * @return
     */
