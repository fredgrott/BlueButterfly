...
import com.github.shareme.bluebutterfly.cards.internal.CardArrayAdapter;
import com.github.shareme.bluebutterfly.cards.internal.CardCursorAdapter;
...
public class CardListView extends ListView implements CardViewWrapper.OnExpandListAnimatorListener {
    ...
    /**
     * Set the adapter. You can provide a {@link CardArrayAdapter}, or a {@link CardCursorAdapter}
    ...
    public void setAdapter(ListAdapter adapter) {
        if (adapter instanceof CardArrayAdapter){
            ...
            Timber.w(TAG,"You are using a generic adapter. Pay attention: your adapter has to call cardArrayAdapter#getView method" );
