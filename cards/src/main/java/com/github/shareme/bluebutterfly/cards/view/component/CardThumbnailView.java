...
package com.github.shareme.bluebutterfly.cards.view.component;
...
import com.github.shareme.bluebutterfly.cards.Constants;
import com.github.shareme.bluebutterfly.cards.R;
import com.github.shareme.bluebutterfly.cards.internal.CardThumbnail;
import com.github.shareme.bluebutterfly.cards.utils.CacheUtil;
 ...
 * </p>
 * This class load a bitmap resource using {@link LruCache} and using an
...
public class CardThumbnailView extends FrameLayout implements CardViewInterface {
    ...
    public static Bitmap decodeSampledBitmapFromResource(Resources res, String resUrl,
        ...
        try {
            ...
            //Url not available
            //ioe.printStackTrace();
            Timber.w("CardThumbnailView","Error while retrieving image",ioe);
        }
        return null;
    }
