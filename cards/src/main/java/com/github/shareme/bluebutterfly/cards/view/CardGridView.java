...
import com.github.shareme.bluebutterfly.cards.internal.CardGridArrayAdapter;
import com.github.shareme.bluebutterfly.cards.internal.CardGridCursorAdapter;
...
public class CardGridView extends GridView implements CardViewWrapper.OnExpandListAnimatorListener {
    ...
    public void setAdapter(ListAdapter adapter) {
        if (adapter instanceof CardGridArrayAdapter){
            ...
            Timber.w(TAG,"You are using a generic adapter. Pay attention: your adapter has to call cardGridArrayAdapter#getView method." );
    ...
    public void onExpandStart(CardViewWrapper viewCard,View expandingLayout) {
        ...
        Timber.w(TAG,"Don't use this kind of animation in a grid");
    }
