...
import com.github.shareme.bluebutterfly.cards.internal.base.BaseCardArrayAdapter;
...
import com.github.shareme.bluebutterfly.cards.view.listener.SwipeDismissListViewTouchListener;
import com.github.shareme.bluebutterfly.cards.view.listener.SwipeOnScrollListener;
import com.github.shareme.bluebutterfly.cards.view.listener.UndoBarController;
import com.github.shareme.bluebutterfly.cards.view.listener.UndoCard;
import com.github.shareme.bluebutterfly.cards.view.listener.dismiss.DefaultDismissableManager;
...
public class CardArrayAdapter extends BaseCardArrayAdapter implements UndoBarController.UndoListener {
     ...
     * @param cardView {@link CardViewWrapper}
     */
        ...
        public void onDismiss(ListView listView, int[] reverseSortedPositions) {
            ...
            for (int position : reverseSortedPositions) {
                ...
                if (card != null) {
                    ...
                    Timber.e(TAG,"Error on swipe action. Impossible to retrieve the card from position");
                }
            }
        ...
        if (token != null) {
            ...
            if (itemPositions != null) {
                ...
                for (int i = end - 1; i >= 0; i--) {
                    ...
                    if (id==null){
                        Timber.w(TAG, "You have to set a id value to use the undo action");
                    }else{
        ...
        if (enableUndo) {
            ...
            if (mUndoBarController==null){
                ...
                if (mContext!=null && mContext instanceof Activity) {
                    ...
                    Timber.e(TAG,"Undo Action requires a valid Activity context");
