...
package com.github.shareme.bluebutterfly.cards.view;
...
import com.github.shareme.bluebutterfly.cards.internal.CardExpand;
import com.github.shareme.bluebutterfly.cards.internal.CardHeader;
import com.github.shareme.bluebutterfly.cards.internal.CardThumbnail;
import com.github.shareme.bluebutterfly.cards.internal.ViewToClickToExpand;
import com.github.shareme.bluebutterfly.cards.view.base.CardViewWrapper;
import com.github.shareme.bluebutterfly.cards.view.component.CardHeaderView;
import com.github.shareme.bluebutterfly.cards.view.component.CardThumbnailView;
import com.github.shareme.bluebutterfly.cards.view.helper.CardViewHelper;
import com.github.shareme.bluebutterfly.cards.view.helper.CardViewHelperUtil;
import com.github.shareme.bluebutterfly.cards.view.listener.SwipeDismissViewTouchListener;
...
public class CardViewNative extends android.support.v7.widget.CardView implements CardViewWrapper {
    ...
    protected void buildUI() {
        ...
        if (mCard == null) {
            Timber.e(TAG, "No card model found. Please use setCard(card) to set all values.");
            return;
        }
        ...
        private static void animateExpanding(final ExpandContainerHelper helper) {
            ...
            if (helper.getCardView().getOnExpandListAnimatorListener()!=null){
                ...
                if (helper.getCardView().mExpandAnimator != null) {
                    ...
                    if (helper.card.getOnExpandAnimatorEndListener() != null)
                        helper.card.getOnExpandAnimatorEndListener().onExpandEnd(helper.card);
                    Timber.w(TAG,"Does the card have the ViewToClickToExpand?");
                }
            }
        }
    ...
    /**
     * Create a {@link Bitmap} from CardView
     * @return
     */
